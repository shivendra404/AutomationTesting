...
public class TS023 extends BaseClass{
	@BeforeClass
	...
	public void TC020() throws InterruptedException {
		...
		myAccount.click();
		Thread.sleep(2000);
		WebElement transMenu = driver.findElement(By.linkText("Transactions"));
		transMenu.click();
		Assert.assertEquals(driver.getCurrentUrl(), "https://awesomeqa.com/ui/index.php?route=account/transaction");
	}
}
