...
public class TS022 extends BaseClass {
	...
	public void TC019() throws InterruptedException {
		...
		myAccount.click();
		Thread.sleep(2000);
		WebElement orderMenu = driver.findElement(By.linkText("Order History"));
		orderMenu.click();
		Assert.assertEquals(driver.getCurrentUrl(), "https://awesomeqa.com/ui/index.php?route=account/order");
	}
}
